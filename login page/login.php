...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result == 0) {
        ...
        if ($password === $user['Password']) {
            ...
            header("Location: /ff/about/about.php");
            exit();
        } else {
...
<section id="navbar-box">
    <div class="navbar">
        ...
        <a href="\ff\views\adsign-up.php" class="action_btn">sign_up <span class="icon"><ion-icon name="log-in-outline"></ion-icon></span></a>
    </div>
</section>
<audio autoplay loop>
...
<section id="login">
    <div class="login-box">
        <form action="" method="post">
            ...
            <div class="sing-up">
                 :Forgot Password?<a href="\ff\views\email.html">Cliquez ici</a>
                <p>dont have an account???  <a href="\ff\views\adsign-up.php">sing up</a><span class="icon"><ion-icon name="log-in-outline"></ion-icon></span></p>
            </div>
        </form>
    </div>
</section>
